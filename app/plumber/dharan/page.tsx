...
export const metadata: Metadata = {
  title: "Plumber in Dharan | SRIYOG App",
...
export default function FeaturesSection() {
  return (
    <>
      <RedSection title="Plumber in Dharan" />
