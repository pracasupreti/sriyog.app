      ...
      <section className="w-full bg-gray-100 py-10">
        <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-8 lg:px-36">
          <div className="bg-white p-6 md:p-10 shadow text-justify space-y-6 text-black">
            <p>
              Effective Date: <sup>1st</sup> June 2024
            </p>

            <p>
              Sriyog Consulting Pvt. Ltd. (also referred as “SRIYOG”, “us”, “we”
              or “our”) operates the www.sriyog.com website and mobile
              application (hereinafter referred to as the “Service”). This
              policy describes our practices regarding the collection, use, and
              disclosure of personal data while using the service.
            </p>

            <p>
              By using SRIYOG, you agree to the collection and use of
              information in accordance with this policy. The terms defined in
              this policy have the same meaning as in our Terms and Conditions
            ...
            <p>
              We collect different types of data for various purposes to improve
              our services.
            </p>
            ...
            <p>
              <strong>Personal Information Data</strong>
            </p>

            <p>
              We collect personally identifiable information to create your
              profile and help providers connect with you. This includes:
            </p>
            ...
            <p>
              <strong>Usage Information Data</strong>
            </p>
            <p>
              This includes data like IP address, browser type, visited pages,
              time spent, UDIDs, and other diagnostic data.
            </p>
            ...
            <p>
              We use cookies and tracking technologies to monitor activity on
            ...
            <ul className="list-disc pl-6 space-y-1">
              <li>
                <strong>Session Cookies</strong> – Used to operate our service.
              </li>
              <li>
            ...
            <p>
              ...
              located outside your country. By submitting information, you agree
              to this transfer.
            </p>
            ...
            <p>
              We strive to use acceptable means to protect your data, but no
              method of transmission or storage is 100% secure.
            </p>

            <h2 className="text-xl font-semibold">Service Providers</h2>
            <p>
              We may employ third-party companies to assist in providing and
              analyzing our service. They are required to not disclose or use
            ...
            <p>
              ...
              discover that we have collected data from a minor without parental
              consent, we take steps to remove that data.
            </p>

            <h2 className="text-xl font-semibold">Changes to This Policy</h2>
            <p>
              We may update our Privacy Policy periodically. You will be
              notified of changes through our service or email, and the updated
              date will be shown at the top.
            </p>
            ...
            <p>
              ...
              <a
                href="mailto:privacy@sriyog.com"
                className="text-black hover:text-[#8b1414]"
              >
                privacy@sriyog.com
              </a>
            </p>
