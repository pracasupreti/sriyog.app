...
export default function AboutFounder() {
  return (
    <>
        ...
        <div className="max-w-screen-xl mx-auto px-3 sm:px-6 md:px-8 lg:px-36 py-10">
          <div className="flex flex-col lg:flex-row gap-10">
            ...
            <div className="w-full lg:w-7/12">
              ...
              <div className="mt-6 w-40 relative h-[80px]">
                <Image
            ...
            {/* Right Column: Image */}
            <div className="w-full lg:w-5/12 relative h-[400px] lg:h-auto">
              <Image
      ...
      <section className="container-fluid pt-5 pb-5 border-bottom border-faded"></section>
    </>
  );
}
