...
export const metadata: Metadata = {
  title: "Electrician in Nepal | SRIYOG App",
...
export default function FeaturesSection() {
  return (
    <>
      <RedSection title="Electrician in Nepal" />
